...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', default='./datasets/', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        self.parser.add_argument('--name', type=str, default='experiment_name_cityperson', help='name of the experiment. It decides where to store samples and models')
